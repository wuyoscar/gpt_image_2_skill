...
Extends the existing shortcut table with explicit aspect-ratio ladders (16:9,
9:16, 3:2, 2:3) and validates custom WxH against gpt-image-2's documented
constraints: both dimensions are multiples of 16, in [16, 8192], and the
aspect ratio max/min is at most 3:1.
"""
...
SIZE_PRESETS: dict[str, str] = {
    # Existing shortcuts — kept stable for backward compatibility.
    "1k": "1024x1024",
    "2k": "2048x2048",
    "4k": "3840x2160",
    "portrait": "1024x1536",
