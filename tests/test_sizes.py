...
def test_legacy_shortcuts_keep_v0_2_mappings():
...
def test_new_aspect_presets_match_reference_ui():
    # From `生图代码.py` SIZE_PRESETS table.
...
def test_list_presets_contains_legacy_and_new():
